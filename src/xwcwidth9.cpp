...
static bool
bsearch_ival( struct char32_ival *table, size_t size, char32_t c )
{
  size_t piv, bot, top;
...
xwcwidth9( char32_t c )
{
  ...
  static struct char32_ival doublewidth[] = {
    {0x1100, 0x115f},
    {0x231a, 0x231b},
    {0x2329, 0x232a},
    {0x23e9, 0x23ec},
  ...
  static struct char32_ival emoji_wide[] = {
    {0x23ed, 0x23ef},
    {0x23f1, 0x23f2},
    {0x23f8, 0x23fa},
    {0x24c2, 0x24c2},
  ...
  static struct char32_ival ambiguous[] = {
    {0x00a1, 0x00a1},
    {0x00a4, 0x00a4},
    {0x00a7, 0x00a8},
    {0x00aa, 0x00aa},
  ...
  static const size_t doublewidth_cnt =
    sizeof( doublewidth ) / sizeof( doublewidth[ 0 ] );
  static const size_t emoji_wide_cnt =
    sizeof( emoji_wide ) / sizeof( emoji_wide[ 0 ] );
  static const size_t ambiguous_cnt =
    sizeof( ambiguous ) / sizeof( ambiguous[ 0 ] );

  if ( c >= 0x100 ) {
    if ( bsearch_ival( doublewidth, doublewidth_cnt, c ) )
      return 2;
    if ( bsearch_ival( emoji_wide, emoji_wide_cnt, c ) )
      return 2;
  }
  if ( c >= 0x80 && bsearch_ival( ambiguous, ambiguous_cnt, c ) )
    return 2;
